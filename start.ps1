...
if (-not (Test-Path "$env:JAVA_HOME\bin\java.exe")) {
    Write-Host "[ERROR] No se encontro Java 17 en $env:JAVA_HOME" -ForegroundColor Red
    Write-Host "        Ajusta la variable JAVA_HOME en este script." -ForegroundColor Red
    exit 1
}
