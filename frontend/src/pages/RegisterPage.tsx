...
export default function RegisterPage() {
  ...
  const inputClass = "w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-colors";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600 dark:from-gray-900 dark:to-gray-800 px-4 py-8 transition-colors">
      {/* Dark mode toggle */}
      <button
        onClick={toggle}
      ...
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-xl transition-colors">
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">Aula Virtual — Crea tu cuenta</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Usuario</label>
            <input
              type="text"
              value={form.username}
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">Min. 8 caracteres, mayuscula, minuscula, numero y caracter especial</p>
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Confirmar contraseña</label>
            <div className="relative">
              <input
